...
urlpatterns = patterns('',
    ...
    url(r'^rango/account/groups/edit/(?P<pk>\d+)/$', views.UpdateUsergroupsView.as_view(),name='usergroups-edit',),
    ...
    url(r'^rango/study/(?P<category_name_url>\w+)/article/(?P<pk>\d+)/voice$',views.ArticleVoicesUpdateView.as_view(),name='article-voices'),
