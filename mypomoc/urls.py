...
urlpatterns = patterns('',
    ...
    url(r'^rango/account/$',views.front,name='frontpage'),
    ...
    url(r'^rango/account/userprofile/$', views.userprofile,name='userprofile',),
    ...
    url(r'^articles/edit/(?P<pk>\d+)/$', views.ArticleUpdateView.as_view(),name='article-edit',),
    url(r'^articles/delete/(?P<pk>\d+)/$', views.ArticleDeleteView.as_view(),name='article-delete',),
